    ...
    DASHBOARD: {
      ...
      ADMINISTRATION: {
        ...
        COURSES: {
          ...
          EDIT: (id: string) => `/${locale}/dashboard/admin/courses/edit/${id}`,
          VIEW: (id: string) => `/${locale}/dashboard/admin/courses/${id}`,
        },
        GUIDES: {
          ROOT: `/${locale}/dashboard/admin/guides`,
          CREATE: `/${locale}/dashboard/admin/guides/create`,
          VIEW: (id: string) => `/${locale}/dashboard/admin/guides/${id}`,
          EDIT: (id: string) => `/${locale}/dashboard/admin/guides/${id}/edit`,
        },
      },
      COURSES: {
        ROOT: `/${locale}/dashboard/courses`,
        CREATE: `/${locale}/dashboard/courses/create`,
        EDIT: (id: string) => `/${locale}/dashboard/courses/edit?id=${id}`,
      ...
      GUIDES: {
        ...
        EDIT: (id: string) => `/${locale}/dashboard/guides/edit?id=${id}`,
