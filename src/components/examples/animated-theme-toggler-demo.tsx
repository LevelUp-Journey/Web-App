        ...
        <div className="p-8 space-y-8">
            <div>
                ...
                <p className="text-muted-foreground mb-6">
                    Click the buttons below to see the animated theme transition
                    effect
                </p>
            </div>
            ...
            <div className="space-y-6">
                ...
                <div>
                    ...
                    <AnimatedThemeToggler className="h-14 w-14 bg-linear-to-r from-blue-500 to-purple-600 text-white hover:from-blue-600 hover:to-purple-700 transition-all duration-300 rounded-xl shadow-lg hover:shadow-xl transform hover:scale-105" />
                </div>
            </div>
            ...
            <div className="mt-8 p-4 bg-muted rounded-lg">
                ...
                <ul className="list-disc list-inside space-y-1 text-sm text-muted-foreground">
                    <li>
                        Smooth circular animation using View Transitions API
                    </li>
