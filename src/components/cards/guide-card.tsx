...
export default function GuideCard({
  ...
  return (
    ...
    >
      {/* Cover Image */}
      <Link href={PATHS.DASHBOARD.GUIDES.VIEW(guide.id)} className="block">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end">
                <DropdownMenuItem asChild>
                  <Link
                    href={PATHS.DASHBOARD.ADMINISTRATION.GUIDES.EDIT(guide.id)}
                  >
                    Edit Guide
                  </Link>
                </DropdownMenuItem>
                <DropdownMenuItem>Delete Guide</DropdownMenuItem>
              </DropdownMenuContent>
            </DropdownMenu>
          )}
        </div>
