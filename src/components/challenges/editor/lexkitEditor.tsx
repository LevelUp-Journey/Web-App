                ...
                <div
                    ...
                    className={cn(
                        ...
                        item.disabled
                            ...
                            : "cursor-pointer",
                        item.disabled
                            ? props.disabledItemClassName
                            : props.itemClassName,
                    )}
                    style={
                        item.disabled
                            ? props.disabledItemStyle
                            : props.itemStyle
                    }
                    onClick={() => {
...
const shadcnContextMenuExtension = contextMenuExtension.configure({
    ...
    theme: {
        container:
            "lexkit-context-menu z-50 min-w-[8rem] overflow-hidden rounded-md border bg-popover p-1 text-popover-foreground shadow-md",
...
export const extensions = [
    ...
    new DraggableBlockExtension().configure({
        // Create fresh instance to avoid caching issues when switching templates
        ...
        () => ({
            ...
            insertImageFromFile: async (
                ...
                if (imageExtension.config.uploadHandler) {
                    try {
                        const src =
                            await imageExtension.config.uploadHandler(file);
                        ...
                        <Tooltip>
                            <TooltipTrigger asChild>
                                <Toggle
                                    ...
                                    onPressedChange={() =>
                                        commands.setImageAlignment("left")
                                    }
                                >
                        ...
                        <Tooltip>
                            <TooltipTrigger asChild>
                                <Toggle
                                    ...
                                    onPressedChange={() =>
                                        commands.setImageAlignment("right")
                                    }
                                >
                    ...
                    <Tooltip>
                        <TooltipTrigger asChild>
                            <Toggle
                                size="sm"
                                variant={
                                    activeStates.bold ? "outline" : "default"
                                }
                                pressed={activeStates.bold}
                    ...
                    <Tooltip>
                        <TooltipTrigger asChild>
                            <Toggle
                                size="sm"
                                variant={
                                    activeStates.italic ? "outline" : "default"
                                }
                                pressed={activeStates.italic}
                    ...
                    <Tooltip>
                        <TooltipTrigger asChild>
                            <Toggle
                                size="sm"
                                variant={
                                    activeStates.code ? "outline" : "default"
                                }
                                pressed={activeStates.code}
                                onPressedChange={() =>
                                    commands.formatText("code")
                    ...
                    <Tooltip>
                        <TooltipTrigger asChild>
                            <Toggle
                                size="sm"
                                variant={
                                    activeStates.isLink ? "outline" : "default"
                                }
                                pressed={activeStates.isLink}
                                disabled={
                                    !activeStates.isTextSelected &&
...
function EditorContent({
    ...
    useEffect(() => {
        ...
        (commands as any).showCommandPalette = () =>
            ...
            <div className="relative ">
                ...
                >
                    <RichTextPlugin
                        ...
                        placeholder={
                            <div className={shadcnTheme.placeholder}>
                                Start typing...
                            </div>
                        }
