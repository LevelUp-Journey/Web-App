...
export const shadcnTheme: LexKitTheme = {
    ...
    draggable: {
        handle: "w-6 h-6 p-0 flex items-center justify-center bg-background border border-border rounded text-foreground shadow-sm hover:bg-accent hover:text-accent-foreground transition-all duration-200 cursor-grab hover:scale-110 active:scale-95 active:rotate-12 active:cursor-grabbing backdrop-blur-sm",
        handleActive:
