...
export class CommunityController {
    static async createCommunity(request: CreateCommunityRequest): Promise<Community> {
    ...
    static async getCommunities(): Promise<Community[]> {
        ...
        return CommunityAssembler.toEntitiesFromResponse(response.data as CommunityResponse[]);
    }
